...
namespace CinemaMobileClient.Platforms.Android;
...
public class NotificationManagerService : INotificationManagerService
{
    ...
    public void Show(string title, string message)
    {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(Platform.AppContext, channelId)
            ...
            .SetLargeIcon(BitmapFactory.DecodeResource(Platform.AppContext.Resources, Resource.Drawable.tooltip_frame_dark))
            .SetSmallIcon(Resource.Drawable.tooltip_frame_dark);
